...
| `2.1.29` | Specific Claude Code version |
...
podman pull quay.io/guimou/ccbox:2.1.29
```
...
echo "2.1.30" > CLAUDE_VERSION

# Commit and push
git add CLAUDE_VERSION
git commit -m "chore: bump Claude Code version to 2.1.30"
